...
Original file is located at
    https://colab.research.google.com/drive/1T2F_pfEyhMzcc6AdJ_xwlRyjj67whDB-
...
CHECKPOINT_PATH = "../saved_models/lab09"
...
"""As in our experiments before on CIFAR, we normalize the dataset. Additionally, we use small augmentations during training to prevent overfitting."""
...
# %tensorboard --logdir ../saved_models/lab09/tensorboards/ProtoNet/

"""<center width="100%"><img src="https://github.com/phlippe/uvadlc_notebooks/blob/master/docs/tutorial_notebooks/tutorial16/tensorboard_screenshot_ProtoNet.png?raw=1" width="1100px"></center>
...
# Commented out IPython magic to ensure Python compatibility.
# Opens tensorboard in notebook. Adjust the path to your CHECKPOINT_PATH if needed
# %tensorboard --logdir ../saved_models/lab09/tensorboards/ProtoMAML/

"""<center width="100%"><img src="https://github.com/phlippe/uvadlc_notebooks/blob/master/docs/tutorial_notebooks/tutorial16/tensorboard_screenshot_ProtoMAML.png?raw=1" width="1100px"></center>
