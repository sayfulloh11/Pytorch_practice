...
Original file is located at
    https://colab.research.google.com/drive/1Gbz4eUU8P3lJXuIpOORUeJoS2_NF840e
...
1. [Tutorial 7 of Deep Learning @ University of Amsterdam](https://uvadlc-notebooks.readthedocs.io/en/latest/tutorial_notebooks/tutorial7/GNN_overview.html)
...
Below, we will start by importing our standard libraries. We will use PyTorch Lightning as already done in previous Labs.
"""
...
### [REF] Graph Representation

Before starting the discussion of specific neural network operations on graphs, we should consider how to represent a graph. Mathematically, a graph $\mathbb{G}$ is defined as a tuple of a set of nodes/vertices $V$, and a set of edges/links $E$: $\mathbb{G}=(V,E)$. Each edge is a pair of two vertices, and represents a connection between them. For instance, let's look at the following graph:
...
## [Part 3] Experiments on graph structures
...
### Q1. Node-level tasks: Semi-supervised node classification
...
### [REF] Edge-level tasks: Link prediction
...
### Q2. Graph-level tasks: Graph classification
